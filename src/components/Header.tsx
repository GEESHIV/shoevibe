...
const Header: React.FC = () => {
  ...
  const categoryNavigation = [
    { name: 'Home', href: '/' },
    { name: 'heels', href: '/category/men' },
    { name: 'sports', href: '/category/women' },
    { name: 'casual', href: '/category/kids' },
    { name: 'sandles', href: '/category/couple' },
    { name: 'sneakers', href: '/category/classic' },
    { name: 'formal', href: '/category/party-wear' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl md:text-2xl font-bold text-black">ShoeVibe</span>
          </Link>
