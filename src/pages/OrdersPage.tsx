                    ...
                    <div className="lg:col-span-1">
                      ...
                      <div className="flex items-center space-x-4 bg-gray-50 rounded-lg p-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600 mt-1 mb-2">{order.productDescription}</p>
                          <p className="text-xs text-gray-600 mb-1">{order.productDescription}</p>
                          {order.size && (
                            <p className="text-xs text-gray-600">Size: {order.size}</p>
                          )}
                          {order.quantity && (
